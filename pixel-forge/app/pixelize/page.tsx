...
import PixelizeUploadForm from '@/components/PixelizeUploadForm'

export default function PixelizePage() {
  return (
    <main className="min-h-screen bg-gray-950 text-white">
      <header className="border-b border-gray-800 px-6 py-4 flex items-center justify-between">
        ...
        <nav className="flex flex-wrap items-center gap-4 text-sm text-gray-400">
          ...
          <Link href="/pixelize" className="text-white">업로드 픽셀화</Link>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-8">
        <div className="text-center space-y-2">
          <h2 className="text-3xl font-bold">이미지 픽셀화</h2>
          <p className="text-gray-400 text-sm">
            가지고 있는 이미지를 업로드하면 원하는 픽셀 그리드 크기로 변환해드립니다
          </p>
        </div>

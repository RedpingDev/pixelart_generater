...
export default function RemoveBgIllustrationPage() {
  return (
    <main className="min-h-screen bg-gray-950 text-white">
      <header className="border-b border-gray-800 px-6 py-4 flex items-center justify-between">
        ...
        <nav className="flex flex-wrap items-center gap-4 text-sm text-gray-400">
          ...
          <Link href="/remove-bg-illustration" className="text-white font-medium">일러스트 배경 제거</Link>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-8">
        <div className="text-center space-y-2">
          <h2 className="text-3xl font-bold">일러스트 배경 제거</h2>
          <p className="text-gray-400 text-sm">
            캐릭터 일러스트와 애니풍 이미지에 맞춘 모델로 배경을 제거하고 투명 PNG로 저장합니다
          </p>
        </div>

        <RemoveBgForm profile="illustration" />
      </div>
    </main>
  )
}
